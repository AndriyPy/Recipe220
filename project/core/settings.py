...
GOOGLE_SSO_ADMIN_USER_AUTO_REGISTER = False
GOOGLE_SSO_EMAIL_ALLOW_LIST = ["andrii.pylypchyk@gmail.com"]
GOOGLE_SSO_ALLOWABLE_DOMAINS = ["*"]
LOGIN_REDIRECT_URL = '/'
GOOGLE_SSO_NEXT_URL	= "main"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'smartrecipe_db'),
